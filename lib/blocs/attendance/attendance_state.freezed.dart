...
return loaded(_that.history);case _Success() when success != null:
...
return loaded(_that.history);case _Success():
...
class _Loaded implements AttendanceState {
  const _Loaded(final  List<AttendanceModel> history): _history = history;
