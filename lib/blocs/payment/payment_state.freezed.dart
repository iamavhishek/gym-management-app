...
return loaded(_that.payments);case _Success() when success != null:
...
return loaded(_that.payments);case _Success():
...
class _Loaded implements PaymentState {
  const _Loaded(final  List<PaymentModel> payments): _payments = payments;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._payments, _payments));
}
