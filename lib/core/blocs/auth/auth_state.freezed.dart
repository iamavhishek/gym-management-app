...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthInitial value)?  initial,TResult Function( AuthLoading value)?  loading,TResult Function( AuthAuthenticated value)?  authenticated,TResult Function( AuthUnauthenticated value)?  unauthenticated,TResult Function( AuthSuccess value)?  success,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return unauthenticated(_that);case AuthSuccess() when success != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthInitial value)  initial,required TResult Function( AuthLoading value)  loading,required TResult Function( AuthAuthenticated value)  authenticated,required TResult Function( AuthUnauthenticated value)  unauthenticated,required TResult Function( AuthSuccess value)  success,}){
final _that = this;
switch (_that) {
case AuthInitial():
...
return unauthenticated(_that);case AuthSuccess():
return success(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthInitial value)?  initial,TResult? Function( AuthLoading value)?  loading,TResult? Function( AuthAuthenticated value)?  authenticated,TResult? Function( AuthUnauthenticated value)?  unauthenticated,TResult? Function( AuthSuccess value)?  success,}){
final _that = this;
switch (_that) {
case AuthInitial() when initial != null:
return initial(_that);case AuthLoading() when loading != null:
...
return unauthenticated(_that.error);case AuthSuccess() when success != null:
...
return unauthenticated(_that.error);case AuthSuccess():
return success(_that.message);case _:
  throw StateError('Unexpected subclass');
