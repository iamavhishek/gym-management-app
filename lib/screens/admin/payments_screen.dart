...
import 'package:gym_management_app/blocs/payment/payment_event.dart';
import 'package:gym_management_app/blocs/payment/payment_state.dart';
      ...
      body: BlocConsumer<PaymentBloc, PaymentState>(
        ...
        builder: (context, state) {
          return state.maybeWhen(
            ...
            loaded: (payments) => _buildBody(payments),
                ...
                BlocBuilder<MemberBloc, MemberState>(
                  builder: (context, state) {
                    return state.maybeWhen(
                      ...
                      orElse: () => const Text('Failed to load members'),
                    );
                  },
                ),
                ...
                BlocBuilder<PlansBloc, PlansState>(
                  builder: (context, state) {
                    return state.maybeWhen(
                      ...
                      loading: () => const LinearProgressIndicator(),
                      orElse: () => const Text('Failed to load plans'),
                    );
                  },
                ),
                const SizedBox(height: 16),
