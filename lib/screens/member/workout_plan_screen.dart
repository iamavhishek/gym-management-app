...
class _WorkoutPlanScreenState extends State<WorkoutPlanScreen> {
      ...
      body: BlocConsumer<WorkoutBloc, WorkoutState>(
        listener: (context, state) {
          state.maybeWhen(
            success: (message) {
              ...
              if (message.contains('deleted') || message.contains('updated')) {
                _loadData();
              }
            },
        ...
        builder: (context, state) {
          return state.maybeWhen(
            ...
            loaded: (plans) => _buildPlansList(plans),
              ...
              onPressed: () {
                if (widget.memberId != null) {
                  ...
                  Navigator.pushNamed(
                    ...
                    arguments: {'isTemplate': widget.isTemplateMode},
                  );
                }
              },
  ...
  void _editPlan(WorkoutPlanModel plan) {
    Navigator.pushNamed(
      context,
      AppRoutes.trainerWorkoutsAdd,
      arguments: {'plan': plan, 'isTemplate': widget.isTemplateMode},
    ).then((_) => _loadData());
  }
