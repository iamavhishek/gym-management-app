...
return loaded(_that.plans);case _Error() when error != null:
...
return loaded(_that.plans);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class _Loaded implements PlansState {
  const _Loaded(final  List<MembershipPlanModel> plans): _plans = plans;
